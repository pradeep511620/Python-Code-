...
def Extract_all_reviews():
    for i in range(2, 39):
        # login_url = 'https://uk.trustpilot.com/review/raptorsupplies.com?languages=all'
        login_url = f"https://uk.trustpilot.com/review/raptorsupplies.com?languages=all&page={i}"
        print(login_url)
        ...
        for name, title, texts, star, cus_review, country, times in zip_longest(
            ...
            lis = [Review_name, Review_Title, Review_text, Review_stars, Review_cus, Review_country, Review_last_time]
