...
def trustpilot_reviews(URL, connection, cursor, compare_last_time):
    ...
    try:
        ...
        return None  # Exit if any part of the extraction fails
    ...
    for review_time in re_time:
        ...
        if review_date == compare_last_time:
            ...
            mgs = "program terminating because of data already exist"
            send_email(mgs)
            print(mgs)
            sys.exit()
    ...
    mgs = "Data inserted into database successfully"
    send_email(mgs)
    print(mgs)
