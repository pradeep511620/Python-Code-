...
with concurrent.futures.ThreadPoolExecutor(max_workers=15) as executor:
    ...
    # start with 16520 and end 26000
    start_url = 20000
    futures = [executor.submit(get_results, url) for index, url in enumerate(urls[start_url:26000], start=start_url)]
    ...
    df.to_csv('Grainger_116k.csv', mode='a', header=not pd.io.common.file_exists('Grainger_116k.csv'),index=False)
