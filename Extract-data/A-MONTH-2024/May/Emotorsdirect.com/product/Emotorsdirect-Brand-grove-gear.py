...
class WebScraper:
    ...
    def Product_Details(self):
        ...
        try:
            ...
            attr_name = [table.get_text(strip=True) for table in self.soup.find_all('div', class_="spec-label")]
            attr_value = [table.get_text(strip=True) for table in self.soup.find_all('div', class_="spec-data")]
        ...
        try:
            attr_name_1 = [table1.get_text(strip=True) for table1 in self.soup.find_all('div', class_="hlLabel")]
            attr_value_1 = [table1.get_text(strip=True) for table1 in self.soup.find_all('div', class_="hlValue")]
...
def ReadUrlFromList():
    file_path = "C:/Users/PK/Desktop/web-scrapping/A-MONTH-2024/May/Emotorsdirect.com/url/Product-url.csv"
