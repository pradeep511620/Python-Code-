...
urls = []
save_files = open("D:/Web-Scrapping/A-MONTH-2024/May/Regalrexnord-Lesson.com/data/Lesson.csv", "a+", encoding="utf-8")
base_url = ''
...
class WebScraper:
    ...
    def Product_Details(self):
        ...
        try:
            ...
            # -------------------------------------------------- Images ----------------------------------------------------
            try:
                images = [{"src": img.get('href'), "alt": img.get('alt')} for img in self.pk.find('div', class_="row product-gallery app-figure").find_all('a')]
                print('images.....', images)
            except (AttributeError, TypeError, IndexError, NoSuchElementException):
                images = ''
            ...
            print(f"Error{e}")
            with open('remain_url.txt', "a+", encoding='uft-8') as file_save:
                file_save.write(f"{self.url}\n")

            with open('remain_urlsss.txt', "a+", encoding='uft-8') as file_saves:
                file_saves.write(f"{urls}\n")
...
# scaper_name = WebScraper('https://www.regalrexnord.com/products/others/-c-face-kit-tefc-180t-fr-leeson-ultimate-e-motors-176024-00')  # Lession
scaper_name = WebScraper('https://www.regalrexnord.com/products/electric-motors/ac-motors-iec/general-purpose-motors/cast-iron-motors/10hp-7-5kw-1180rpm-df160mc-tefc-230-460v-3ph-60hz-cont-40c-1-15sf-b3-b14-193372-60')  # Lession
...
def ReadUrlFromList():
    file_path = "D:/Web-Scrapping/A-MONTH-2024/May/Regalrexnord-Lesson.com/url/Product-url - Copy.csv"
