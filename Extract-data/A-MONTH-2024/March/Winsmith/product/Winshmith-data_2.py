...
urls = []
save_files = open("C:/Users/PK/Desktop/web-scrapping/A-MONTH-2024/March/Winsmith/data/Winsmith.csv", "a+", encoding="utf-8")
...
def ReadUrlFromList():
    ...
    # print(url_links)
    i = 12004
    for url_count, url in enumerate(url_links[i:15000], start=i):
        urls.append(url)
