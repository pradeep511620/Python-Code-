...
urls = []
save_files = open("C:/Users/PK/Desktop/web-scrapping/A-MONTH-2024/March/Gatescarbondrive.com/data/Gatescarbondrive.csv",
                  "a+", encoding="utf-8")
...
class WebScraper:
    ...
    def Product_Details(self):
        ...
        # --------------------------------------------------------------------------------------------------------------
        try:
            product_title = self.soup.find("div", {"id": "product-details-info"}).find('h2').text.strip()
...
# scaper_name = WebScraper('https://www.gatescarbondrive.com/products/belts/111t-cdc')
