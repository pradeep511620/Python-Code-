...
save_files = open("P:/Web-scrapings/A-MONTH-2024/Aug/Abb-Brand-TY-RAP.com/data/Abb-Brand-TY-RAP.csv", "a+",encoding="utf-8")
base_url = 'https://www.abb.com/'
headers = {
...
class WebScraper:
    ...
    def send_requests_and_driver_from_page_sources(self):
        ...
        try:
            ...
            click_product_button = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, "a#btnRefuseAllCheckboxes")))
            driver.execute_script("arguments[0].click();", click_product_button)
            time.sleep(4)
            print("Successfully clicked the product button.")
    ...
    def Product_Details(self):
        ...
        # ---------------------------------------------- Description_2 -------------------------------------------------
        try:
            description_2 = [find_div.get_text(strip=True, separator=">>") for find_div in self.pk.select(".product__description")]
...
# scraper_names = WebScraper('https://new.abb.com/products/TY5242MXR/7TCG009110R0022')
...
# ----------------------------------------------------------------------------------------------------------------------
def main():
    file_path = "P:/Web-scrapings/A-MONTH-2024/Aug/Abb-Brand-TY-RAP.com/url/Product-url.csv"
