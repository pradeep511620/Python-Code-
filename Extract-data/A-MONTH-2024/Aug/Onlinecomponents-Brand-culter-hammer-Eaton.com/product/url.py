...
def get_url(url):
    ...
    print(df)
    df.to_csv('product_u1.csv', mode='a', header=not pd.io.common.file_exists('product_u1.csv'), index=False)


# get_url('https://www.onlinecomponents.com/en/suppliers/cutler-hammer--eaton-251/')
file_path = r"P:\Web-scrapings\A-MONTH-2024\Aug\Onlinecomponents-Brand-culter-hammer-Eaton.com\product\product_u.csv"
