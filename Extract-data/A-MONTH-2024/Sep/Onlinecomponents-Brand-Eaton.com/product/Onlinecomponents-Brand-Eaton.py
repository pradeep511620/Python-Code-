...
save_files = open("P:/Web-scrapings/A-MONTH-2024/Sep/Onlinecomponents-Brand-Eaton.com/data/Onlinecomponents-Brand-Eaton.csv", "a+",encoding="utf-8")
...
# scraper_names = WebScraper('https://www.onlinecomponents.com/en/productdetail/eaton-emobility-transportation-powerstor-bussmann/b10970914-56801562.html')
# scraper_names.Product_Details()


# ----------------------------------------------------------------------------------------------------------------------
def main():
    file_path = "P:/Web-scrapings/A-MONTH-2024/Sep/Onlinecomponents-Brand-Eaton.com/url/Product-url.csv"
