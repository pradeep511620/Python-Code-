...
save_files = open("P:/Web-scrapings/A-MONTH-2024/July/Supplyhouse-Brand-SpeedClean.com/data/Supplyhouse-Brand-SpeedClean.csv", "a+", encoding="utf-8")
...
class WebScraper:
    ...
    def Product_Details(self):
        ...
        # --------------------------------------------------- MPN ------------------------------------------------------
        try:
            mpn = self.pk.select_one("div.iXetAF.ProductPageHeaderDetailsValue-sc-1sia5h6-0").text.strip()
            print('SKU.....', mpn)
        except (AttributeError, TypeError, IndexError, Exception) as e:
            mpn = ''
...
# scraper_names = WebScraper('https://www.supplyhouse.com/SpeedClean-CJ-125-CoilJet-CJ-125-HVAC-Coil-Cleaner-System')
...
# ----------------------------------------------------------------------------------------------------------------------
def main():
    file_path = "P:/Web-scrapings/A-MONTH-2024/July/Supplyhouse-Brand-SpeedClean.com/url/Product-url.csv"
