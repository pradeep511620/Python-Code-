...
def FetchProductUrl(driver):
    for product in driver.find_elements(By.XPATH, "//section[@aria-label='Product Gallery']//a"):
...
def ReadFromListUrl():
    ...
    url_list = [
        ...
        'https://www.launchtechusa.com/products?Category=All&page=1',
        'https://www.launchtechusa.com/products?Category=All&page=2',
        'https://www.launchtechusa.com/products?Category=All&page=3',
    ]
