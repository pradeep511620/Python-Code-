...
def FetchProductUrl(driver):
    ...
    for field in driver.find_element(By.CLASS_NAME, "product-form__swatch").find_elements(By.XPATH, "//*[@class='product-form__swatch__label']"):
        field.click()
        time.sleep(4)
        Current_url = driver.current_url
        save = open('current-url.txt', "a+", encoding='utf-8')
        save.write(f"{Current_url}\n")
