...
def FetchProductUrl(driver):
    ...
    for product in driver.find_elements(By.XPATH, "//table[@id='plp-table-filter']//tbody//a"):
...
def ReadFromListUrl():
    file_path = "C:/Users/PK/Desktop/web-scrapping/A-MONTH-2024/Jan/Keystonefastening.com/product/keystone.csv"
    url_lists = pd.read_csv(file_path)["URLs"]

    url_list = [
        "https://www.keystonefastening.com/viewitems/ducts-specialty-products-clamps-clips-plain-clamps/cialty-products-clamps-clips-plain-clamps-cj-clips"
