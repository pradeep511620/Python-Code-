...
save_files = open("C:/Users/PK/Desktop/web-scrapping/A-MONTH-2024/Jan/CS Johnson.com/data/CS Johnson-all-data.csv", 'a',
                  encoding='utf-8')
...
def product_detail(url, soup):
    ...
    # ------------------------------------------------ Title -----------------------------------------------------------
    try:
        product_title = soup.find("div", {"id": "content"}).h1.text.strip()
    ...
    try:
        image = []
        table = soup.find("div", {"class": "col-sm-8"})
...
def Get_Specs_Table(url, soup, product_title, sku):
    #   /var/www/html/webscr/destination_dir
    save = open("C:/Users/PK/Desktop/web-scrapping/A-MONTH-2024/Jan/CS Johnson.com/data/CS Johnson-specs.txt", 'a+',
                encoding='utf-8')
    print('Tables')
    try:
...
def main():
    ...
    file_path = "C:/Users/PK/Desktop/web-scrapping/A-MONTH-2024/Jan/CS Johnson.com/url/CJ Johnson-product-url.csv"
