...
# base_url = 'https://dripless.com/en/driplessecwidcom/#!/ETS4000-400ml-Sausage-Gun/p/347932764/category=48753066'
...
data_file = open('dripless_data_updated.csv', 'a', encoding='utf-8')
...
def driver_call(base_url):
    ...
    try:
        brand = driver.find_element(By.XPATH, '//*[@id="my-store-2442022"]/div[2]/div/div/div[2]/div/div[2]/div/div[1]/div/div[1]/div[2]/div[3]/div[2]/div[2]/div[1]/div[1]/span[2]').text
    except NoSuchElementException:
        brand = 'upc not available'
    try:
