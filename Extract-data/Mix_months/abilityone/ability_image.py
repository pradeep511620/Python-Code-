...
for url in Result:
    try:
        ...
        print("*********************************** Images : **************************************")
        image = driver.find_element(By.CLASS_NAME, 'mcs-wrapper').find_elements(By.TAG_NAME,'img')
        for y in image:
            image_d = y.get_attribute('src') if y else "Not Found"
            print("image_d = ", image_d)

            save_details: TextIO = open("imag1.xlsx", "a+", encoding="utf-8")
            save_details.write("\n" + url + "\t" + image_d)
            print("End")
            save_details.close()
            print("\n ***** Record stored into Table image . *****")
