...
save_files = open("grainger-plumbing-all-data.csv", 'a', encoding='utf-8')
...
def data_table(url, mpn, soup):
    ...
    for a, b in zip(name, value):
        pass
        # print(a, ".....", b)
        save = open('grainger-table.txt', 'a+', encoding='utf-8')
        save.write('\n' + url + "\t" + mpn + "\t" + a + "\t" + b)
    print('save data into files')


def main():
    for csv_link in range(24301, 25000):            # start point 1 t0 20000 and start point 20000 to 25000
