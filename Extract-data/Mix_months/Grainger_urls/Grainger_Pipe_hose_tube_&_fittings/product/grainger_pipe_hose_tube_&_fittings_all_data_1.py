...
save_files = open(f"C:/Users/PK/Desktop/Web-Scrapping/Grainger_urls/Grainger_Pipe_hose_tube_&_fittings/data/pipe_hose_fittings_data_1.csv", 'a', encoding='utf-8')
...
def data_table(url, mpn, soup):
    ...
    for a, b in zip(name, value):
        # print(a, ".....", b)
        # pass
        save = open(f'C:/Users/PK/Desktop/Web-Scrapping/Grainger_urls/Grainger_Pipe_hose_tube_&_fittings/data/grainger_table_1.txt', 'a+', encoding='utf-8')
        save.write('\n' + url + "\t" + mpn + "\t" + a + "\t" + b)
...
def main():
    count_url = 29066
    for url in mylst[count_url:30000]:  # end and start point ..... 0 to 30000          Totals number of url 54945
