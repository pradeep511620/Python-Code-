...
for url in mylist:
    try:
        ...
        lists1 = []
        all_data = []
        table2 = driver.find_element(By.XPATH, "//div[@class='fsskuspecifications']")
        # print(table2.text)
        th1 = table2.find_elements(By.TAG_NAME, 'th')
        for t in th1:
            lists.append(t.text)

        td1 = table2.find_elements(By.TAG_NAME, 'td')
        for u in td1:
            lists1.append(u.text)
