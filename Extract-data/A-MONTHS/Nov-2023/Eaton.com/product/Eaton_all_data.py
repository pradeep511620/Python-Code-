...
save_files = open("C:/Users/PK/Desktop/web-scrapping/A-MONTHS/Nov-2023/eaton.com/data/eaton-all-data.csv", 'a', encoding='utf-8')
...
def Get_Specs_Table(url, soup, product_title, mpn):
    #   /var/www/html/webscr/destination_dir
    save = open("C:/Users/PK/Desktop/web-scrapping/A-MONTHS/Nov-2023/eaton.com/data/eaton-specs.txt", 'a+', encoding='utf-8')
    print('Tables')
    # print(soup.prettify())
...
def main():
    ...
    url_link = pd.read_csv("C:/Users/PK/Desktop/web-scrapping/A-MONTHS/Nov-2023/eaton.com/url/eaton_product_url.csv")['URL']
    print(len(url_link))
    i = 0
