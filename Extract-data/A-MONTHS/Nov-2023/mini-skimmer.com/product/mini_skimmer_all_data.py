...
save_files = open("C:/Users/PK/Desktop/web-scrapping/A-MONTHS/Nov-2023/mini-skimmer.com/data/mini_skimmer-all-data.csv", 'a', encoding='utf-8')
...
def product_detail(url, driver):
    ...
    # ------------------------------------------------------------------------------------------------------------------
    try:
        l3_name = driver.find_element(By.XPATH, "//nav[@class='woocommerce-breadcrumb']").text.strip()
    ...
    try:
        option = driver.find_element(By.XPATH, "//select[@id='reach']")
        ...
        for i in range(1, len(clickable) + 1):
            ...
            if "Choose an option" not in clk.text:
                ...
                option_2 = driver.find_element(By.XPATH, "//select[@id='motor-speed']")
...
def Get_Specs_Table(url, driver, product_title, skus):
    ...
    save = open("C:/Users/PK/Desktop/web-scrapping/A-MONTHS/Nov-2023/mini-skimmer.com/data/mini_skimmer-specs.txt", 'a+', encoding='utf-8')
    print('Tables')
    # print(soup.prettify())
...
def main():
    ...
    url_link = pd.read_csv("C:/Users/PK/Desktop/web-scrapping/A-MONTHS/Nov-2023/mini-skimmer.com/url/mini_skimmer-product-url.csv")['URL']
    print(len(url_link))
    i = 20
