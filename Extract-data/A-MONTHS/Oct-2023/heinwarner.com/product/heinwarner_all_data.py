...
save_files = open("C:/Users/PK/Desktop/web-scrapping/A-MONTHS/Oct-2023/heinwarner.com/data/heinwarner-all-data.csv",
                  'a', encoding='utf-8')
...
def product_detail(url, soup):
    try:
        ...
        # ------------------------------------------------------------------------------------------------------------------
        try:
            product_title = soup.find('span', {"id": "cph_Content_top_item_description_lbl"}).text.strip()
...
def main():
    ...
    url_link = \
    pd.read_csv("C:/Users/PK/Desktop/web-scrapping/A-MONTHS/Oct-2023/heinwarner.com/url/heinwarner-product-url.csv")['URL']
    i = 171
