...
product_data = open("stearn_brakes_mroSupplies_product_data4.csv", 'a', encoding='utf-8')
# product_specs = open("/var/www/html/web_scr/scrapped_data/stearn_brakes_mroSupplies__specs.csv", 'a', encoding='utf-8')
product_specs = open("stearn_brakes_mroSupplies__specs4.csv", 'a', encoding='utf-8')
