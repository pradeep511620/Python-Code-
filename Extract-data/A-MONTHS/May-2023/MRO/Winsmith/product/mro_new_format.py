...
product_data = open("C:/Users/PK/Desktop/Web-Scrapping/May-2023/MRO/Winsmith/data/winsmith_mroSupplies_product_data.csv", 'a', encoding='utf-8')
# product_specs = open("/var/www/html/web_scr/scrapped_data/stearn_brakes_mroSupplies__specs.csv", 'a', encoding='utf-8')
product_specs = open("C:/Users/PK/Desktop/Web-Scrapping/May-2023/MRO/Winsmith/data/winsmith_mroSupplies__specs.csv", 'a', encoding='utf-8')
