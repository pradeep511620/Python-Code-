...
product_data = open("C:/Users/PK/Desktop/Web-Scrapping/May-2023/MRO/Winsmith/data/winsmith_mroSupplies_product_data1.csv", 'a', encoding='utf-8')
# product_specs = open("/var/www/html/web_scr/scrapped_data/stearn_brakes_mroSupplies__specs.csv", 'a', encoding='utf-8')
product_specs = open("C:/Users/PK/Desktop/Web-Scrapping/May-2023/MRO/Winsmith/data/winsmith_mroSupplies__specs1.csv", 'a', encoding='utf-8')
...
def main():
    ...
    product_urls = pd.read_csv('C:/Users/PK/Desktop/Web-Scrapping/May-2023/MRO/Winsmith/urls/Winsmith_urls.csv')['urls']
    """using i indexing product url default i value is 0"""
    for url in product_urls[i:]:   # start point 0 to 10000
        print(i, ">>>>>>>>>>>>>", url)
        try:
